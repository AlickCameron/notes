...
### Textbook
- *STAT2: Building Models for a World of Data* by Cannon et al., W.H. Freeman and Company, 2013.
- One copy on 2-hour reserve at the Mudd

### Class sessions
- MWF will focus on learning new methods
- Real examples emphasized

### Lab sessions
- Tuesdays will focus on making sure that you are comfortable with using R for statistical modeling


## Grading

### Exploratory data analyses (5%)
- You need to explore new data sets before we discuss them in class

### Homework (25%)
- Approximately weekly assignments
- Typically due in class on Fridays
- No late work 

### Analysis projects (70%)
- 3 projects focusing on different types of regression models
